class UserAuthenticationController < ApplicationController
  ...
  def create_cookie
    ...
    if user != nil
      ...
      if are_they_legit == false
        ...
        redirect_to("/messages", { :notice => "Signed in successfully." })
      end
    else
  ...
  def create
    ...
    @user.vendor = params.fetch("query_vendor", false)
    ...
    if save_status == true
      ...
      redirect_to("/messages", { :notice => "User account created successfully."})
    else
  ...
  def update
    ...
    if @user.valid?
      ...
      redirect_to("/messages", { :notice => "User account updated successfully."})
    else
  ...
  def about
    render({ :template => "application/about.html.erb"})
  end
